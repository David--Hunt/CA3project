...
im_mech.gkbar = 5e-5 # maximum conductance (7e-5)
#---------------------------------------------------
...
soma.gcabar_it = 0.002 # maximum conductance
#---------------------------------------------------
soma.insert ('ical') # adds L-type calcium channel
soma.cai = 2.4e-4 # internal calcium (mM)
soma.cao = 2 # external calcium (mM)
soma.eca = 120 # calcium reversal (mV)
soma.gcabar_ical = 1e-4 # maximum conductance
#---------------------------------------------------
...
soma.ek = -80
soma.gkdbar_kd = 7e-5 # maximum conductance
#---------------------------------------------------
soma.insert ('napinst')
soma.ena = 50
soma.gbar_napinst = 1e-8 # (3e-5)
...
iclamp.amp = .29 # amplitude of iclamp current injection 
